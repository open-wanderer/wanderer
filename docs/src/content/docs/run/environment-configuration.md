...
| PUBLIC_MAP_LOW_ZOOM_THRESHOLD | Zoom level below which low zoom clustering rules apply | 8 |
| PUBLIC_MAP_MEDIUM_ZOOM_THRESHOLD | Zoom level below which medium zoom clustering rules apply | 10 |
