---
title: SRCH0 — Designarchiv vom 1. September 2026
description: Nichtnormative, vollständige Langfassung des abgelösten SRCH0-Entwurfs mit Korrektur-, Migrations-, Recovery- und Runtimekonzepten.
editUrl: false
sidebar:
  order: 99
  badge: Archiv
spec:
  id: SRCH0-DESIGN-ARCHIVE-2026-09-01
  kind: evidence
  status: superseded
  lastReviewed: '2026-09-01'
---

:::caution[Nicht normatives, supersediertes Designarchiv]
Diese Seite ist die vollständige Langfassung von SRCH0 unmittelbar vor der
Reduktion auf Bestandsvertrag und kanonischen Testkorpus. Sie bewahrt
Korrektur-, Migrations-, Recovery-, Readiness-, Task- und Cutoverüberlegungen
als historischen Entwurfsstand, autorisiert aber keine Implementierung und
setzt keine Abhängigkeit oder Freigabebedingung. Normativ ist ausschliesslich
der schlanke [SRCH0-Bestandsvertrag](/develop/specs/trail-search/work-items/search/srch0/);
Zielkorrekturen und Betriebsmechanismen gelten nur, soweit ihre heutigen
Delivery-Owner sie in eigene normative Overlays oder Verträge übernehmen.
:::

## Weiterverwendung der Exploration

| Archivthema | Heutiger normativer Owner |
| --- | --- |
| beobachteter Bestand, Case-IDs und Referenzkorpus | [SRCH0](/develop/specs/trail-search/work-items/search/srch0/) |
| heutiger Indexbootstrap, Offline-Rebuild und `SearchReadinessV1` | [IDX0](/develop/specs/trail-search/work-items/engine/idx0/) |
| `_geoRadius`, Legacycompiler, Proxy- und DTO-Grenze | [SRCH-COMP](/develop/specs/trail-search/work-items/search/srch-comp/) |
| Difficulty-Presence/-Unknown und Trailbackfill | [SRCH2](/develop/specs/trail-search/work-items/search/srch2/) |
| lokale Listenaggregate, ACL, Netzwerk und Token | [Federation-Security / SEC-VIS-0](/develop/specs/trail-search/contracts/federation-security/) |
| Engineupgrade, Dump/Restore und Betreiber-Rebuild | [M1](/develop/specs/trail-search/work-items/engine/m1/) |
| persistente Authority-, Generationen-, Publisher- und Recoveryautomaten | [STATE1](/develop/specs/trail-search/contracts/federation-index-gateway-state-machines-v1/) und IDX1–IDX3 |

Die nachfolgende Langfassung bleibt unverändert als Herkunfts- und
Entscheidungsbeleg lesbar. Konstruktionen, deren Voraussetzung durch die
Entkopplung entfallen ist – insbesondere der gemeinsame Zwei-Paar-
Korrekturcutover – werden nicht allein durch ihre Archivierung normativ.
