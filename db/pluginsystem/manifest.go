...
func ValidateManifest(manifest Manifest) error {
	...
	if manifest.Type != PluginTypeTrails && manifest.Type != PluginTypeAssets && manifest.Type != PluginTypeRouting {
		return fmt.Errorf("%w: type must be one of %q, %q, %q", ErrUnsupportedPluginType, PluginTypeTrails, PluginTypeAssets, PluginTypeRouting)
	}
