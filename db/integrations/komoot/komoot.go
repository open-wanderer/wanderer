...
func syncTrailWithTours(app core.App, k *KomootApi, i KomootIntegration, user string, actor string, tours []KomootTour) (bool, error) {
	...
	for _, tour := range tours {
		...
		trailid, err := createTrailFromTour(app, k, detailedTour, gpx, user, actor)
		if err != nil {
...
func createTrailFromTour(app core.App, k *KomootApi, detailedTour *DetailedKomootTour, gpx *filesystem.File, user string, actor string) (string, error) {
