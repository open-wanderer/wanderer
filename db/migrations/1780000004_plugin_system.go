...
func init() {
	m.Register(func(app core.App) error {
		if err := createInstalledPluginsCollection(app); err != nil {
			return err
		}
		return createPluginJobsCollection(app)
	}, func(app core.App) error {
		if collection, err := app.FindCollectionByNameOrId("plugin_jobs"); err == nil {
...
func createPluginJobsCollection(app core.App) error {
	if _, err := app.FindCollectionByNameOrId("plugin_jobs"); err == nil {
		return nil
	}
