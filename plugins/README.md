...
Repeat for `hammerhead`, `immich`, `komoot`, and `valhalla` as needed.
...
| `routing` | Routing plugins only. Describes host defaults such as routing/elevation roles and built-in profile keys. |
