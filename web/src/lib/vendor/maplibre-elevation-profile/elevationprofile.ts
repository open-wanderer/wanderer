import type { GeoJsonObject, LineString, Position } from "geojson";
...
import { geoJsonObjectToPositionsAndTimes } from "./geojson";
export { geoJsonObjectToPositionsAndTimes } from "./geojson";
