...
export type ExternalServiceUrlKey = "VALHALLA_ROUTE_URL" | "VALHALLA_HEIGHT_URL" | "VALHALLA_NAVIGATE_URL" | "VALHALLA_TRACE_ROUTE_URL" | "NOMINATIM_URL" | "OVERPASS_API_URL";
