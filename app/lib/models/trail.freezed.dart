...
mixin _$Trail {
 ...
 String get id; String get collectionId; String get name; String? get location;@_NullableDateTimeConverter() DateTime? get date; bool get public; double get distance;@JsonKey(name: 'elevation_gain') double get elevationGain;@JsonKey(name: 'elevation_loss') double get elevationLoss; double get duration; TrailDifficulty get difficulty; double? get lat; double? get lon;@JsonKey(name: 'max_lat') double get maxLat;@JsonKey(name: 'max_lon') double get maxLon;@JsonKey(name: 'min_lat') double get minLat;@JsonKey(name: 'min_lon') double get minLon; int get thumbnail; List<String> get photos; String? get gpx; DateTime get created; DateTime get updated; String? get category; String? get subcategory; List<String> get tags; String? get polyline; String? get domain; String? get iri;@JsonKey(name: 'like_count') int get likeCount; TrailExpand? get expand; String get description; String get author; bool get isOffline; List<String> get localPhotos; List<String> get pmTiles; List<String> get demPmTiles;
...
@useResult
$Res call({
 String id, String collectionId, String name, String? location,@_NullableDateTimeConverter() DateTime? date, bool public, double distance,@JsonKey(name: 'elevation_gain') double elevationGain,@JsonKey(name: 'elevation_loss') double elevationLoss, double duration, TrailDifficulty difficulty, double? lat, double? lon,@JsonKey(name: 'max_lat') double maxLat,@JsonKey(name: 'max_lon') double maxLon,@JsonKey(name: 'min_lat') double minLat,@JsonKey(name: 'min_lon') double minLon, int thumbnail, List<String> photos, String? gpx, DateTime created, DateTime updated, String? category, String? subcategory, List<String> tags, String? polyline, String? domain, String? iri,@JsonKey(name: 'like_count') int likeCount, TrailExpand? expand, String description, String author, bool isOffline, List<String> localPhotos, List<String> pmTiles, List<String> demPmTiles
});
...
/// Create a copy of Trail
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? collectionId = null,Object? name = null,Object? location = freezed,Object? date = freezed,Object? public = null,Object? distance = null,Object? elevationGain = null,Object? elevationLoss = null,Object? duration = null,Object? difficulty = null,Object? lat = freezed,Object? lon = freezed,Object? maxLat = null,Object? maxLon = null,Object? minLat = null,Object? minLon = null,Object? thumbnail = null,Object? photos = null,Object? gpx = freezed,Object? created = null,Object? updated = null,Object? category = freezed,Object? subcategory = freezed,Object? tags = null,Object? polyline = freezed,Object? domain = freezed,Object? iri = freezed,Object? likeCount = null,Object? expand = freezed,Object? description = null,Object? author = null,Object? isOffline = null,Object? localPhotos = null,Object? pmTiles = null,Object? demPmTiles = null,}) {
  return _then(_self.copyWith(
...
as List<String>,pmTiles: null == pmTiles ? _self.pmTiles : pmTiles // ignore: cast_nullable_to_non_nullable
as List<String>,demPmTiles: null == demPmTiles ? _self.demPmTiles : demPmTiles // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
/// Create a copy of Trail
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String collectionId,  String name,  String? location, @_NullableDateTimeConverter()  DateTime? date,  bool public,  double distance, @JsonKey(name: 'elevation_gain')  double elevationGain, @JsonKey(name: 'elevation_loss')  double elevationLoss,  double duration,  TrailDifficulty difficulty,  double? lat,  double? lon, @JsonKey(name: 'max_lat')  double maxLat, @JsonKey(name: 'max_lon')  double maxLon, @JsonKey(name: 'min_lat')  double minLat, @JsonKey(name: 'min_lon')  double minLon,  int thumbnail,  List<String> photos,  String? gpx,  DateTime created,  DateTime updated,  String? category,  String? subcategory,  List<String> tags,  String? polyline,  String? domain,  String? iri, @JsonKey(name: 'like_count')  int likeCount,  TrailExpand? expand,  String description,  String author,  bool isOffline,  List<String> localPhotos,  List<String> pmTiles,  List<String> demPmTiles)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Trail() when $default != null:
return $default(_that.id,_that.collectionId,_that.name,_that.location,_that.date,_that.public,_that.distance,_that.elevationGain,_that.elevationLoss,_that.duration,_that.difficulty,_that.lat,_that.lon,_that.maxLat,_that.maxLon,_that.minLat,_that.minLon,_that.thumbnail,_that.photos,_that.gpx,_that.created,_that.updated,_that.category,_that.subcategory,_that.tags,_that.polyline,_that.domain,_that.iri,_that.likeCount,_that.expand,_that.description,_that.author,_that.isOffline,_that.localPhotos,_that.pmTiles,_that.demPmTiles);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String collectionId,  String name,  String? location, @_NullableDateTimeConverter()  DateTime? date,  bool public,  double distance, @JsonKey(name: 'elevation_gain')  double elevationGain, @JsonKey(name: 'elevation_loss')  double elevationLoss,  double duration,  TrailDifficulty difficulty,  double? lat,  double? lon, @JsonKey(name: 'max_lat')  double maxLat, @JsonKey(name: 'max_lon')  double maxLon, @JsonKey(name: 'min_lat')  double minLat, @JsonKey(name: 'min_lon')  double minLon,  int thumbnail,  List<String> photos,  String? gpx,  DateTime created,  DateTime updated,  String? category,  String? subcategory,  List<String> tags,  String? polyline,  String? domain,  String? iri, @JsonKey(name: 'like_count')  int likeCount,  TrailExpand? expand,  String description,  String author,  bool isOffline,  List<String> localPhotos,  List<String> pmTiles,  List<String> demPmTiles)  $default,) {final _that = this;
switch (_that) {
case _Trail():
return $default(_that.id,_that.collectionId,_that.name,_that.location,_that.date,_that.public,_that.distance,_that.elevationGain,_that.elevationLoss,_that.duration,_that.difficulty,_that.lat,_that.lon,_that.maxLat,_that.maxLon,_that.minLat,_that.minLon,_that.thumbnail,_that.photos,_that.gpx,_that.created,_that.updated,_that.category,_that.subcategory,_that.tags,_that.polyline,_that.domain,_that.iri,_that.likeCount,_that.expand,_that.description,_that.author,_that.isOffline,_that.localPhotos,_that.pmTiles,_that.demPmTiles);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String collectionId,  String name,  String? location, @_NullableDateTimeConverter()  DateTime? date,  bool public,  double distance, @JsonKey(name: 'elevation_gain')  double elevationGain, @JsonKey(name: 'elevation_loss')  double elevationLoss,  double duration,  TrailDifficulty difficulty,  double? lat,  double? lon, @JsonKey(name: 'max_lat')  double maxLat, @JsonKey(name: 'max_lon')  double maxLon, @JsonKey(name: 'min_lat')  double minLat, @JsonKey(name: 'min_lon')  double minLon,  int thumbnail,  List<String> photos,  String? gpx,  DateTime created,  DateTime updated,  String? category,  String? subcategory,  List<String> tags,  String? polyline,  String? domain,  String? iri, @JsonKey(name: 'like_count')  int likeCount,  TrailExpand? expand,  String description,  String author,  bool isOffline,  List<String> localPhotos,  List<String> pmTiles,  List<String> demPmTiles)?  $default,) {final _that = this;
switch (_that) {
case _Trail() when $default != null:
return $default(_that.id,_that.collectionId,_that.name,_that.location,_that.date,_that.public,_that.distance,_that.elevationGain,_that.elevationLoss,_that.duration,_that.difficulty,_that.lat,_that.lon,_that.maxLat,_that.maxLon,_that.minLat,_that.minLon,_that.thumbnail,_that.photos,_that.gpx,_that.created,_that.updated,_that.category,_that.subcategory,_that.tags,_that.polyline,_that.domain,_that.iri,_that.likeCount,_that.expand,_that.description,_that.author,_that.isOffline,_that.localPhotos,_that.pmTiles,_that.demPmTiles);case _:
  return null;
...
class _Trail extends Trail {
  const _Trail({required this.id, this.collectionId = 'trails', required this.name, this.location, @_NullableDateTimeConverter() this.date, this.public = false, this.distance = 0, @JsonKey(name: 'elevation_gain') this.elevationGain = 0, @JsonKey(name: 'elevation_loss') this.elevationLoss = 0, this.duration = 0, this.difficulty = TrailDifficulty.easy, this.lat, this.lon, @JsonKey(name: 'max_lat') this.maxLat = 0, @JsonKey(name: 'max_lon') this.maxLon = 0, @JsonKey(name: 'min_lat') this.minLat = 0, @JsonKey(name: 'min_lon') this.minLon = 0, this.thumbnail = 0, final  List<String> photos = const [], this.gpx, required this.created, required this.updated, this.category, this.subcategory, final  List<String> tags = const [], this.polyline, this.domain, this.iri, @JsonKey(name: 'like_count') this.likeCount = 0, this.expand, this.description = "", this.author = "000000000000000", this.isOffline = false, final  List<String> localPhotos = const [], final  List<String> pmTiles = const [], final  List<String> demPmTiles = const []}): _photos = photos,_tags = tags,_localPhotos = localPhotos,_pmTiles = pmTiles,_demPmTiles = demPmTiles,super._();
...
@override@JsonKey() List<String> get localPhotos {
 ...
 final  List<String> _pmTiles;
@override@JsonKey() List<String> get pmTiles {
  if (_pmTiles is EqualUnmodifiableListView) return _pmTiles;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_pmTiles);
}

 final  List<String> _demPmTiles;
@override@JsonKey() List<String> get demPmTiles {
  if (_demPmTiles is EqualUnmodifiableListView) return _demPmTiles;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_demPmTiles);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Trail&&(identical(other.id, id) || other.id == id)&&(identical(other.collectionId, collectionId) || other.collectionId == collectionId)&&(identical(other.name, name) || other.name == name)&&(identical(other.location, location) || other.location == location)&&(identical(other.date, date) || other.date == date)&&(identical(other.public, public) || other.public == public)&&(identical(other.distance, distance) || other.distance == distance)&&(identical(other.elevationGain, elevationGain) || other.elevationGain == elevationGain)&&(identical(other.elevationLoss, elevationLoss) || other.elevationLoss == elevationLoss)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.difficulty, difficulty) || other.difficulty == difficulty)&&(identical(other.lat, lat) || other.lat == lat)&&(identical(other.lon, lon) || other.lon == lon)&&(identical(other.maxLat, maxLat) || other.maxLat == maxLat)&&(identical(other.maxLon, maxLon) || other.maxLon == maxLon)&&(identical(other.minLat, minLat) || other.minLat == minLat)&&(identical(other.minLon, minLon) || other.minLon == minLon)&&(identical(other.thumbnail, thumbnail) || other.thumbnail == thumbnail)&&const DeepCollectionEquality().equals(other._photos, _photos)&&(identical(other.gpx, gpx) || other.gpx == gpx)&&(identical(other.created, created) || other.created == created)&&(identical(other.updated, updated) || other.updated == updated)&&(identical(other.category, category) || other.category == category)&&(identical(other.subcategory, subcategory) || other.subcategory == subcategory)&&const DeepCollectionEquality().equals(other._tags, _tags)&&(identical(other.polyline, polyline) || other.polyline == polyline)&&(identical(other.domain, domain) || other.domain == domain)&&(identical(other.iri, iri) || other.iri == iri)&&(identical(other.likeCount, likeCount) || other.likeCount == likeCount)&&(identical(other.expand, expand) || other.expand == expand)&&(identical(other.description, description) || other.description == description)&&(identical(other.author, author) || other.author == author)&&(identical(other.isOffline, isOffline) || other.isOffline == isOffline)&&const DeepCollectionEquality().equals(other._localPhotos, _localPhotos)&&const DeepCollectionEquality().equals(other._pmTiles, _pmTiles)&&const DeepCollectionEquality().equals(other._demPmTiles, _demPmTiles));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,collectionId,name,location,date,public,distance,elevationGain,elevationLoss,duration,difficulty,lat,lon,maxLat,maxLon,minLat,minLon,thumbnail,const DeepCollectionEquality().hash(_photos),gpx,created,updated,category,subcategory,const DeepCollectionEquality().hash(_tags),polyline,domain,iri,likeCount,expand,description,author,isOffline,const DeepCollectionEquality().hash(_localPhotos),const DeepCollectionEquality().hash(_pmTiles),const DeepCollectionEquality().hash(_demPmTiles)]);
...
as List<String>,pmTiles: null == pmTiles ? _self._pmTiles : pmTiles // ignore: cast_nullable_to_non_nullable
as List<String>,demPmTiles: null == demPmTiles ? _self._demPmTiles : demPmTiles // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
