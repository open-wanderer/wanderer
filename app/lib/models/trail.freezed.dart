...
@override
String toString() {
  return 'Trail(id: $id, collectionId: $collectionId, name: $name, location: $location, date: $date, public: $public, completed: $completed, distance: $distance, elevationGain: $elevationGain, elevationLoss: $elevationLoss, duration: $duration, movingDuration: $movingDuration, difficulty: $difficulty, lat: $lat, lon: $lon, maxLat: $maxLat, maxLon: $maxLon, minLat: $minLat, minLon: $minLon, thumbnail: $thumbnail, photos: $photos, gpx: $gpx, created: $created, updated: $updated, category: $category, subcategory: $subcategory, tags: $tags, polyline: $polyline, domain: $domain, iri: $iri, likeCount: $likeCount, expand: $expand, description: $description, author: $author, isOffline: $isOffline, localPhotos: $localPhotos)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,collectionId,name,location,date,public,completed,distance,elevationGain,elevationLoss,duration,movingDuration,difficulty,lat,lon,maxLat,maxLon,minLat,minLon,thumbnail,const DeepCollectionEquality().hash(_photos),gpx,created,updated,category,subcategory,const DeepCollectionEquality().hash(_tags),polyline,domain,iri,likeCount,expand,description,author,isOffline,const DeepCollectionEquality().hash(_localPhotos)]);
