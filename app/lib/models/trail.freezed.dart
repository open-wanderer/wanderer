...
@override
String toString() {
  return 'Trail(id: $id, collectionId: $collectionId, name: $name, location: $location, date: $date, public: $public, completed: $completed, distance: $distance, elevationGain: $elevationGain, elevationLoss: $elevationLoss, duration: $duration, difficulty: $difficulty, lat: $lat, lon: $lon, maxLat: $maxLat, maxLon: $maxLon, minLat: $minLat, minLon: $minLon, thumbnail: $thumbnail, photos: $photos, gpx: $gpx, created: $created, updated: $updated, category: $category, subcategory: $subcategory, tags: $tags, polyline: $polyline, domain: $domain, iri: $iri, likeCount: $likeCount, expand: $expand, description: $description, author: $author, isOffline: $isOffline, localPhotos: $localPhotos)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String collectionId,  String name,  String? location, @_NullableDateTimeConverter()  DateTime? date,  bool public,  bool completed,  double distance, @JsonKey(name: 'elevation_gain')  double elevationGain, @JsonKey(name: 'elevation_loss')  double elevationLoss,  double duration,  TrailDifficulty difficulty,  double? lat,  double? lon, @JsonKey(name: 'max_lat')  double maxLat, @JsonKey(name: 'max_lon')  double maxLon, @JsonKey(name: 'min_lat')  double minLat, @JsonKey(name: 'min_lon')  double minLon,  int thumbnail,  List<String> photos,  String? gpx,  DateTime created,  DateTime updated,  String? category,  String? subcategory,  List<String> tags,  String? polyline,  String? domain,  String? iri, @JsonKey(name: 'like_count')  int likeCount,  TrailExpand? expand,  String description,  String author,  bool isOffline,  List<String> localPhotos)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Trail() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String collectionId,  String name,  String? location, @_NullableDateTimeConverter()  DateTime? date,  bool public,  bool completed,  double distance, @JsonKey(name: 'elevation_gain')  double elevationGain, @JsonKey(name: 'elevation_loss')  double elevationLoss,  double duration,  TrailDifficulty difficulty,  double? lat,  double? lon, @JsonKey(name: 'max_lat')  double maxLat, @JsonKey(name: 'max_lon')  double maxLon, @JsonKey(name: 'min_lat')  double minLat, @JsonKey(name: 'min_lon')  double minLon,  int thumbnail,  List<String> photos,  String? gpx,  DateTime created,  DateTime updated,  String? category,  String? subcategory,  List<String> tags,  String? polyline,  String? domain,  String? iri, @JsonKey(name: 'like_count')  int likeCount,  TrailExpand? expand,  String description,  String author,  bool isOffline,  List<String> localPhotos)  $default,) {final _that = this;
switch (_that) {
case _Trail():
return $default(_that.id,_that.collectionId,_that.name,_that.location,_that.date,_that.public,_that.completed,_that.distance,_that.elevationGain,_that.elevationLoss,_that.duration,_that.difficulty,_that.lat,_that.lon,_that.maxLat,_that.maxLon,_that.minLat,_that.minLon,_that.thumbnail,_that.photos,_that.gpx,_that.created,_that.updated,_that.category,_that.subcategory,_that.tags,_that.polyline,_that.domain,_that.iri,_that.likeCount,_that.expand,_that.description,_that.author,_that.isOffline,_that.localPhotos);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,collectionId,name,location,date,public,completed,distance,elevationGain,elevationLoss,duration,difficulty,lat,lon,maxLat,maxLon,minLat,minLon,thumbnail,const DeepCollectionEquality().hash(_photos),gpx,created,updated,category,subcategory,const DeepCollectionEquality().hash(_tags),polyline,domain,iri,likeCount,expand,description,author,isOffline,const DeepCollectionEquality().hash(_localPhotos)]);
