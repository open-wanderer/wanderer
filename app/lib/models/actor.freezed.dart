...
mixin _$Actor {
 ...
 String get id; String get username;@JsonKey(name: 'preferred_username') String get preferredUsername; String? get domain; String? get summary; String? get published; int? get followerCount; int? get followingCount; String get iri; String get inbox; String? get outbox; String? get icon; String? get followers; String? get following; bool get isLocal;@JsonKey(name: 'public_key') String get publicKey;@JsonKey(name: 'last_fetched') String get lastFetched; String get user;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,username,preferredUsername,domain,summary,published,followerCount,followingCount,iri,inbox,outbox,icon,followers,following,isLocal,publicKey,lastFetched,user);

@override
String toString() {
  return 'Actor(id: $id, username: $username, preferredUsername: $preferredUsername, domain: $domain, summary: $summary, published: $published, followerCount: $followerCount, followingCount: $followingCount, iri: $iri, inbox: $inbox, outbox: $outbox, icon: $icon, followers: $followers, following: $following, isLocal: $isLocal, publicKey: $publicKey, lastFetched: $lastFetched, user: $user)';
}
...
@useResult
$Res call({
 String id, String username,@JsonKey(name: 'preferred_username') String preferredUsername, String? domain, String? summary, String? published, int? followerCount, int? followingCount, String iri, String inbox, String? outbox, String? icon, String? followers, String? following, bool isLocal,@JsonKey(name: 'public_key') String publicKey,@JsonKey(name: 'last_fetched') String lastFetched, String user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String username, @JsonKey(name: 'preferred_username')  String preferredUsername,  String? domain,  String? summary,  String? published,  int? followerCount,  int? followingCount,  String iri,  String inbox,  String? outbox,  String? icon,  String? followers,  String? following,  bool isLocal, @JsonKey(name: 'public_key')  String publicKey, @JsonKey(name: 'last_fetched')  String lastFetched,  String user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Actor() when $default != null:
return $default(_that.id,_that.username,_that.preferredUsername,_that.domain,_that.summary,_that.published,_that.followerCount,_that.followingCount,_that.iri,_that.inbox,_that.outbox,_that.icon,_that.followers,_that.following,_that.isLocal,_that.publicKey,_that.lastFetched,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String username, @JsonKey(name: 'preferred_username')  String preferredUsername,  String? domain,  String? summary,  String? published,  int? followerCount,  int? followingCount,  String iri,  String inbox,  String? outbox,  String? icon,  String? followers,  String? following,  bool isLocal, @JsonKey(name: 'public_key')  String publicKey, @JsonKey(name: 'last_fetched')  String lastFetched,  String user)  $default,) {final _that = this;
switch (_that) {
case _Actor():
return $default(_that.id,_that.username,_that.preferredUsername,_that.domain,_that.summary,_that.published,_that.followerCount,_that.followingCount,_that.iri,_that.inbox,_that.outbox,_that.icon,_that.followers,_that.following,_that.isLocal,_that.publicKey,_that.lastFetched,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String username, @JsonKey(name: 'preferred_username')  String preferredUsername,  String? domain,  String? summary,  String? published,  int? followerCount,  int? followingCount,  String iri,  String inbox,  String? outbox,  String? icon,  String? followers,  String? following,  bool isLocal, @JsonKey(name: 'public_key')  String publicKey, @JsonKey(name: 'last_fetched')  String lastFetched,  String user)?  $default,) {final _that = this;
switch (_that) {
case _Actor() when $default != null:
return $default(_that.id,_that.username,_that.preferredUsername,_that.domain,_that.summary,_that.published,_that.followerCount,_that.followingCount,_that.iri,_that.inbox,_that.outbox,_that.icon,_that.followers,_that.following,_that.isLocal,_that.publicKey,_that.lastFetched,_that.user);case _:
  return null;
...
/// Create a copy of Actor
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? username = null,Object? preferredUsername = null,Object? domain = freezed,Object? summary = freezed,Object? published = freezed,Object? followerCount = freezed,Object? followingCount = freezed,Object? iri = null,Object? inbox = null,Object? outbox = freezed,Object? icon = freezed,Object? followers = freezed,Object? following = freezed,Object? isLocal = null,Object? publicKey = null,Object? lastFetched = null,Object? user = null,}) {
  return _then(_Actor(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,username: null == username ? _self.username : username // ignore: cast_nullable_to_non_nullable
as String,preferredUsername: null == preferredUsername ? _self.preferredUsername : preferredUsername // ignore: cast_nullable_to_non_nullable
