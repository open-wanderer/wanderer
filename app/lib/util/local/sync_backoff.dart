/// The backoff curve and attempt ceiling, expressed as pure, testable
/// policy with no dependency beyond `dart:core`.
///
/// Deliberately no retryable-vs-permanent error taxonomy: the
...
/// as [TrailSyncState.failed] and stops retrying automatically. Must
