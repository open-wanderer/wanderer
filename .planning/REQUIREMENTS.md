...
## Post-v1.8 Phase Requirements

**Not part of the v1.8 milestone** — deliberately kept out of the v1 list above so its coverage
stats keep describing the shipped milestone. These are scheduled against a specific phase (unlike
the deferred items under "Future Requirements"), and are claimed by whichever milestone next picks
that phase up.

### Downloaded Trails (Phase 38)
...
### Post-v1.8 (not counted in v1 coverage above)
