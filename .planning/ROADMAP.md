...
- [ ] 26-01-PLAN.md — Pure trail-coverage util (bboxesOverlap/overlappingRegions/missingCoverageRegions) + table-driven tests (GUARD-01/04)
...
| 26. Trail Download Guard | v1.6 | 0/3 | Planned | - |
