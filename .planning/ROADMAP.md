...
- [ ] 24-04-PLAN.md — Gap closure (UAT re-run tests 1/3): _buildActiveRow renders row status from the live ephemeral downloadState (resolveRowStatus util) instead of the ToOne-stale region.status, so a vector download shows downloading/progress/pause and pause-mid-transfer becomes observable (SETUI-03/04)
...
| 24. Settings — Offline Maps/Regions UI | v1.6 | 3/3 | Complete   | 2026-07-22 |
